  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      try {
        ...
        Swal.fire({
          icon: "error",
          title: "유저 닉네임 수정 중 오류가 발생했습니다.",
          text: `상세 내용: ${(error as Error).message}`,
        });
      }
    },
    [nickname, userEmail],
